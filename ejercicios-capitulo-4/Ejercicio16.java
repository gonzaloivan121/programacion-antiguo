...
public class Ejercicio16 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("TEST DE (IN)FIDELIDAD");
    System.out.println("Este programa hará preguntas y deducirá a partir de ellas si tu pareja te está siendo infiel.\n");
    ...
    if ( puntos <= 10 ) {
      System.out.print("No hay problema alguno, tu pareja te está siendo fiel.");
    }
